...
> Stand: 2026-07-13 · v1.0 · Schwester-Dokumente: `ENGINEERING-PRINCIPLES.md` · `infrastructure-playbook.md`
...
- Ref `umbuggxvbluxbejdekvd`, eu-west-1. Tabellen: skills (21), categories (8), context_sources,
  mails, executions, feedback, governance, auth_credentials.
...
- KI-Betriebssystem: BERENT Skill Executor (`suljizPHm2nCwXCl`) · Mail Ingestion iCloud
  ...
  (`nBmkteHSFECAOlOA`, Schedule 03:00 + Webhook).
...
- Anthropic: n8n-Credential „Anthropic API"; Modellwahl nach Engineering §4.1.
...
| berent-os service (`sb_secret_…`) | ① n8n-Credential „BERENT-OS Supabase" ② nr7/.env.local ③ Vercel nr7 Env `SUPABASE_BERENT_OS_SERVICE_KEY` ④ Passwortmanager | Ingestion/Durchsicht-Writes, NR7 mails+auth, Export-Script |
