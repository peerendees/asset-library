...
Zentrales Icon-Set für alle BERENT.ai-Projekte.

## Verwendung
Kopiere die benötigten Icons in dein Projekt-`public/`-Verzeichnis.

## Icon-Übersicht
| Datei | Größe | Verwendung |
|-------|-------|------------|
| favicon-32.png | 32×32 | Browser-Tab |
| favicon-32-dark.png | 32×32 | Browser-Tab (Dark Mode) |
